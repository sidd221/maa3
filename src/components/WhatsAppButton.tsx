...
export default function WhatsAppButton() {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.a
          href="https://wa.me/919431008188"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-20 md:bottom-16 right-4 md:right-8 z-50 w-14 h-14 flex items-center justify-center bg-[#25D366] text-white rounded-full shadow-xl hover:-translate-y-1 transition-all duration-300"
