...
const faqs = [
  ...
  { q: "Are the remedies purely natural?", a: "Yes. Our remedies are prepared from natural substances (plants, minerals, etc.) using a highly specialised mathematical process of dilution and potentization, rendering them completely safe and free from crude chemicals." },
