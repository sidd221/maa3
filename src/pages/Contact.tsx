            ...
            <div className="bg-neutral-light rounded-2xl p-6 mb-8 border border-gray-100 max-w-lg">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-text-dark/70 mt-1 leading-relaxed">Dr Pradeep Kumar B.H.M.S ( B.U )<br/>Patna, Bihar, House No - 2, Road Number - 2, near, Atal Path, Indrapuri, Patna, Bihar 800024.</p>
                </div>
              </div>
            </div>
