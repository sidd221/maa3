...
const categories = ["All", "Chronic", "Paediatric", "Skin", "Women", "Men", "Mental"];

const treatments = [
  { id: 1, name: "Asthma & Bronchitis", category: "Chronic", duration: "6-12 Months", desc: "Holistic care to improve lung capacity, reduce dependence on inhalers, and prevent recurrent attacks by strengthening immunity.", fullDesc: "Our classical homoeopathic approach focuses on identifying your specific allergy triggers. We prescribe medicines that desensitize the immune system slowly, reducing bronchial hyperreactivity and ensuring long-term relief from wheezing and breathlessness.", image: "/asthma.jpeg" },
  ...
  { id: 3, name: "Migraine", category: "Chronic", duration: "4-8 Months", desc: "Identify and treat specific triggers of your migraine for permanent relief rather than temporary pain suppression.", fullDesc: "We analyse your specific headache patterns—whether triggered by stress, sun, hormones, or digestion. The customised medicine reduces the frequency and intensity of attacks until they completely stop.", image: "/Migraine.jpeg" },
  { id: 4, name: "PCOD & Fibroids", category: "Women", duration: "6-18 Months", desc: "Natural hormonal regulation without synthetic hormones or invasive surgeries.", fullDesc: "Homoeopathy offers excellent results in dissolving cysts and regularizing menstrual cycles by correcting the endocrine axis. It also helps manage associated symptoms like weight gain, acne, and mood swings naturally.", image: "/PCOD & Fibroids.jpeg" },
  { id: 5, name: "Recurrent Infections", category: "Paediatric", duration: "3-6 Months", desc: "Build robust immunity in children who fall sick frequently with colds, tonsillitis, or ear infections.", fullDesc: "Instead of repeated antibiotic courses which weaken gut flora, we give sweet homoeopathic pills that children love. These medicines stimulate the child's own immune defences, making them resilient to seasonal changes and school viruses.", image: "/recurrent infections.jpeg" },
  { id: 6, name: "Anxiety & Depression", category: "Mental", duration: "6-12 Months", desc: "Gentle healing for mental distress without habit-forming sedatives or dulling of emotions.", fullDesc: "We understand that mental health is deeply connected to physical well-being. Our detailed psychiatric consultation helps find the simillimum—the exact remedy matching your grief, anxiety, or stress pattern, restoring emotional balance naturally.", image: "/Anxiety and depression.jpeg" },
  { id: 7, name: "Thyroid Disorders", category: "Women", duration: "12-24 Months", desc: "Stimulate the thyroid gland to function optimally, helping reduce or eliminate artificial hormone dependence.", fullDesc: "Whether it's Hypo or Hyperthyroidism, our treatment targets the autoimmune or stress factors causing the glandular dysfunction, eventually aiming to restore natural thyroxine production.", image: "/Thyroid disorder.jpeg" },
  { id: 8, name: "Osteoarthritis", category: "Chronic", duration: "Ongoing Management", desc: "Pain relief, reduction of joint stiffness, and improvement in mobility for age-related joint wear and tear.", fullDesc: "While structural damage cannot be reversed, homoeopathic remedies significantly reduce inflammation, arrest further cartilage degeneration, and manage pain effectively without NSAIDs.", image: "/osteoarthritis.jpeg" },
  { id: 9, name: "ADHD & Behavioural Issues", category: "Paediatric", duration: "8-16 Months", desc: "Improve concentration, reduce hyperactivity, and manage temper tantrums in a safe, child-friendly manner.", fullDesc: "We avoid strong psychiatric drugs for growing brains. Our remedies calm the nervous system and improve cognitive focus naturally, helping the child perform better socially and academically.", image: "/ADHD & Behavioural Issues.jpeg" },
  { id: 10, name: "Anal Diseases (Piles, Fissures, Fistula)", category: "Chronic", duration: "4-10 Months", desc: "Non-surgical, permanent relief from pain, bleeding, and discomfort associated with anorectal conditions.", fullDesc: "Homoeopathy successfully treats hemorrhoids and fissures by addressing the underlying cause—usually chronic constipation and portal vein engorgement. The medicines reduce swelling, stop bleeding, and promote healing of the anal mucosa without any painful procedures.", image: "/Anal Diseases (Piles, Fissures, Fistula).jpg" },
  ...
  { id: 13, name: "Allergies & Rhinitis", category: "Chronic", duration: "3-8 Months", desc: "Long-term relief from frequent sneezing, runny nose, and seasonal allergies by boosting immunity.", fullDesc: "Allergic rhinitis often stems from an overactive immune system. Our homoeopathic remedies work to desensitize the body to allergens naturally, reducing reliance on antihistamines and improving overall respiratory health.", image: "/Allergies & Rhinitis.jpeg" },
  { id: 14, name: "Vitiligo", category: "Skin", duration: "12-24 Months", desc: "Safe, holistic approach to address pigmentation loss by correcting underlying autoimmune triggers.", fullDesc: "Vitiligo is primarily an autoimmune condition. Homoeopathy offers constitutional treatments that aim to stabilize the immune system, halt the progression of depigmentation, and stimulate melanocytes naturally.", image: "/vitiligo.jpeg" },
  { id: 15, name: "Menopause Issues", category: "Women", duration: "6-12 Months", desc: "Natural management of hot flashes, mood swings, and bone health without hormone replacement therapy.", fullDesc: "Menopause is a natural transition, but its symptoms can be disruptive. We provide carefully selected homoeopathic remedies that balance hormones inherently, easing the transition and improving quality of life.", image: "/Menopause Issues.jpeg" },
  ...
  { id: 17, name: "Bedwetting (Enuresis)", category: "Paediatric", duration: "3-8 Months", desc: "Gentle correction of involuntary urination during sleep, treating both physical and emotional factors.", fullDesc: "Bedwetting can cause significant distress to both child and parents. Homoeopathy treats this safely by addressing bladder sphincter tone and alleviating any underlying fears or anxieties.", image: "/Bedwetting (Enuresis).jpeg" },
  { id: 18, name: "Acne & Pimples", category: "Skin", duration: "4-8 Months", desc: "Clear cystic acne and prevent scarring by addressing hormonal imbalances and blood purification.", fullDesc: "Topical creams only offer temporary results. Homoeopathic medicines work from within, regulating hormones, reducing sebum production, and clearing the skin to prevent future breakouts and scarring.", image: "/Acne & Pimples.jpeg" },
  { id: 19, name: "Rheumatoid Arthritis", category: "Chronic", duration: "12-24 Months", desc: "Manage autoimmune joint inflammation, reduce deformities, and improve daily function.", fullDesc: "Rheumatoid arthritis requires deep-acting constitutional remedies to correct the progressive autoimmune attack on the joints. Homoeopathy provides relief from severe morning stiffness, pain, and swelling.", image: "/Rheumatoid Arthritis.jpeg" },
  { id: 20, name: "Sciatica & Back Pain", category: "Chronic", duration: "3-8 Months", desc: "Relief from sharp radiating nerve pain and chronic lower back discomfort.", fullDesc: "Sciatic nerve compression can cause debilitating radiating pain. Homoeopathic treatment focuses on reducing inflammation around the nerve root and relieving muscle spasms naturally, promoting mobility.", image: "/Sciatica & Back Pain.jpeg" },
  { id: 21, name: "Warts & Corns", category: "Skin", duration: "2-6 Months", desc: "Permanent, painless removal of viral warts and corns without surgery or freezing.", fullDesc: "Warts are viral growths that often return after painful freezing or burning procedures. Homoeopathic medicines act as systemic antiviral agents, causing the warts to naturally shrink and fall off without leaving scars.", image: "/Warts & Corns.jpeg" },
  { id: 22, name: "Tonsillitis", category: "Paediatric", duration: "3-6 Months", desc: "Permanent cure for recurrent throat infections and enlarged tonsils without surgery.", fullDesc: "Homoeopathy offers a highly effective alternative to tonsillectomy. By enhancing the child's natural immunity, the medicines reduce the inflammation of the tonsils, preventing recurrent episodes of pain, fever, and difficulty swallowing.", image: "/tonsils.jpeg" },
  { id: 23, name: "Spondylitis", category: "Chronic", duration: "6-12 Months", desc: "Relief from neck and back pain, stiffness, and restricted movement caused by cervical or lumbar spondylosis.", fullDesc: "Degenerative changes in the spine can cause severe pain and nerve compression. Homoeopathic medicines reduce inflammation in the spinal joints, relieve muscle spasms, and halt further degeneration.", image: "/spondylitis.jpeg" },
  { id: 24, name: "Liver Disorders", category: "Chronic", duration: "6-12 Months", desc: "Treatment for fatty liver, jaundice, and other hepatic conditions to restore normal liver function.", fullDesc: "The liver is a vital organ for detoxification and metabolism. Homoeopathic remedies help reduce fat accumulation in cases of fatty liver, improve digestion, and support overall hepatic health.", image: "/Liver Disorders.jpeg" },
  { id: 25, name: "Prostate Issues (BPH)", category: "Men", duration: "6-12 Months", desc: "Manage symptoms of an enlarged prostate like frequent urination and poor flow naturally.", fullDesc: "Benign Prostatic Hyperplasia (BPH) is common in older men. Homoeopathy provides effective relief from urinary urgency, hesitancy, and incomplete emptying by reducing prostate inflammation.", image: "/Prostate Issues.jpeg" },
  { id: 26, name: "Stomach & Gas Issues", category: "Chronic", duration: "3-6 Months", desc: "Relief from chronic acidity, bloating, indigestion, and frequent gas without daily antacids.", fullDesc: "Digestive discomforts often result from irregular eating habits and stress. Homoeopathic treatment identifies the root cause and restores optimal digestive function naturally.", image: "/Stomach & Gas Issues.jpeg" },
  { id: 27, name: "UTI & Bladder Issues", category: "Women", duration: "2-4 Months", desc: "Effective treatment for recurrent urinary tract infections and burning sensation during urination.", fullDesc: "Frequent UTIs can be frustrating. Homoeopathic medicines work to eliminate the underlying susceptibility to infections, providing lasting relief and preventing recurrences.", image: "/UTI & Bladder Issues.jpeg" },
  { id: 28, name: "Sexual Disorders", category: "Men", duration: "6-12 Months", desc: "Confidential and effective treatment for erectile dysfunction, premature ejaculation, and low libido.", fullDesc: "Sexual health issues often have both physical and psychological roots. Homoeopathic remedies address performance anxiety, improve stamina, and restore vitality naturally.", image: "/Sexual Disorders.jpeg" },
  { id: 29, name: "Gallbladder Stones", category: "Chronic", duration: "6-12 Months", desc: "Non-surgical approach to naturally dissolve small gallstones and manage associated pain.", fullDesc: "Homoeopathy offers gentle medicines that aid in dissolving smaller, non-obstructive gallstones and reducing gallbladder inflammation, thereby relieving colic and improving fat digestion.", image: "/Gallbladder Stones.jpeg" },
  ...
  return (
    <div className="w-full bg-transparent">
      <section className="bg-primary pt-16 pb-24 px-4 text-center text-white">
        ...
        >
          Comprehensive Homoeopathy Treatment in Patna for over 200+ distinct medical conditions.
        </motion.p>
      </section>
