...
const treatments = [
  ...
  { id: 17, name: "Bedwetting (Enuresis)", category: "Pediatric", duration: "3-8 Months", desc: "Gentle correction of involuntary urination during sleep, treating both physical and emotional factors.", fullDesc: "Bedwetting can cause significant distress to both child and parents. Homoeopathy treats this safely by addressing bladder sphincter tone and alleviating any underlying fears or anxieties.", image: "/Bedwetting (Enuresis).jpeg" },
